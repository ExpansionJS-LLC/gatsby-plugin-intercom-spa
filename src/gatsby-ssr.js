    ...
    <script
      ...
      dangerouslySetInnerHTML={{
        __html: `
          ...
          }';var x=d.getElementsByTagName('script')[0];x.parentNode.insertBefore(s,x);}function ld(){setTimeout(l, ${pluginOptions.delay_timeout ||
          0});}if(w.attachEvent){w.attachEvent('onload',ld);}else{w.addEventListener('load',ld,false);}}})();
          `
      }}
    />
  ]);
